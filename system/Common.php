...
function master_admin_view($page, $data = array()) {
    ...
    echo view('masteradmin/common/header', $data);
    echo view('masteradmin/common/sidebar', $data);
    echo view('masteradmin/common/topnavigation', $data);
    echo view($page, $data);
    echo view('masteradmin/common/footer', $data);
}
